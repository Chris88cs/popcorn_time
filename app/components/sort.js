        ...
        <>
            <div>
                <div style={{ height: 40 + 'px' }}>
                    ...
                    <div className="inline-block text-center font-bold truncate border-b border-r border-gray-500 relative" style={{ width: 7 + 'vw', height: 40 + 'px', paddingTop: 5 + 'px' }}><div className="no-underline" dangerouslySetInnerHTML={{ __html: SortUrl_vote_average }}></div><div className="absolute right-1" style={{ top: 6 + "px" }} dangerouslySetInnerHTML={{ __html: order_vote_average }}></div></div>
                    <div className="inline-block text-center font-bold truncate border-b border-gray-500" style={{ width: 3.2 + 'vw', height: 40 + 'px', paddingTop: 5 + 'px' }}></div>
                </div>
            </div>
