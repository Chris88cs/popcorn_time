    ...
    return (
        <>
            <div className="items-center px-2 flex justify-end" >
                <div className="relative mr-3" style={{ width: 35 + 'vw' }} >
                    <input type="text" id="searchText" style={{ width: 35 + 'vw' }} className="block p-2 text-gray-900 bg-gray-50 rounded-lg border border-gray-300 " placeholder="Search Here..." value={stateOfInput} onChange={(e) => setStateOfInput(e.target.value)} />
                ...
                <button className="cursor-pointer shadow-outline border rounded" style={{ padding: 8 + 'px', width: 150 + 'px' }} onClick={resetClick} >RESET ALL</button>
            </div>
